...
#if VANITYGAPS_PATCH
static const unsigned int all_gaps = 0;
static const unsigned int gappih         = all_gaps;  /* horiz inner gap between windows */
static const unsigned int gappiv         = all_gaps;  /* vert inner gap between windows */
static const unsigned int gappoh         = all_gaps;  /* horiz outer gap between windows and screen edge */
static const unsigned int gappov         = all_gaps;  /* vert outer gap between windows and screen edge */
...
#endif // TAB_PATCH
#if BAR_HEIGHT_PATCH
static const int bar_height              = 38;   /* 0 means derive from font, >= 1 explicit height */
...
#else
static const char *fonts[]               = { "SauceCodePro Mono:pixelsize=14:style=bold",
...
static const char *const autostart[] = {
	"/home/alex/dwm-flexipatch/autostart.sh", NULL,
	NULL /* terminate */
};
...
#endif // NAMETAG_PATCH
{
	[DEFAULT_TAGS]        = { "١", "٢","٣", "٤","٥", "٦", "٧", "٨", "٩" },
	//[DEFAULT_TAGS]        = { "一", "二", "三", "四", "五", "六", "七", "八", "九" },
	//[DEFAULT_TAGS]        = { "1", "2", "3", "4", "5", "6", "7", "8", "9" },
	[ALTERNATIVE_TAGS]    = { "󰈹", "󰨞", "󰝰", "", "󰭹", "󰙏", "", "", "󰚌" },
...
static const Rule rules[] = {
	...
	RULE(.class = "dolphin", .tags = 1 << 2)
	RULE(.class = "gitkraken", .tags = 1 << 7)
	RULE(.class = "Gitkraken", .tags = 1 << 7)
...
/* backlight */
static const char *brightnessup[] = { "light", "-T", "1.2", NULL };
static const char *brightnessdown[] = { "light", "-T", "0.8", NULL };
...
static const char *togglemic[] = {"/home/alex/dwm-flexipatch/scripts/togglemic.sh", NULL};
static const char *upmicvol[] = {"amixer", "set", "Capture", "5%+", NULL};
static const char *downmicvol[] = {"amixer", "set", "Capture", "5%-", NULL};

/* Rofi and powermenu */
static const char *rofi[] = {"/home/alex/.config/rofi/launch.sh", NULL};
static const char *powermenu[] = {"/home/alex/.config/rofi/scripts/powermenu_t1", NULL};

/* Pomodoro */
static const char *pomodoroSkip[] = {"/home/alex/dwm-flexipatch/pomodoro/i3-gnome-pomodoro", "skip", NULL};
static const char *pomodoroStartStop[] = {"/home/alex/dwm-flexipatch/pomodoro/i3-gnome-pomodoro", "start-stop", NULL};
static const char *pomodoroToggle[] = {"/home/alex/dwm-flexipatch/pomodoro/i3-gnome-pomodoro", "toggle", NULL};
...
static const char *gitkrakenCmd[] = {"gitkraken", NULL};
static const char *obsidianCmd[] = {"obsidian", NULL};

static const char* redshiftBrightnessUp[] = { "/home/alex/dwm-flexipatch/scripts/redshift.py", "0", "+0.1", NULL };
static const char* redshiftBrightnessDown[] = { "/home/alex/dwm-flexipatch/scripts/redshift.py", "0", "-0.1", NULL };
static const char* redshiftTemperatureUp[] = { "/home/alex/dwm-flexipatch/scripts/redshift.py", "500", "0", NULL };
static const char* redshiftTemperatureDown[] = { "/home/alex/dwm-flexipatch/scripts/redshift.py", "-500", "0", NULL };
static const char* redshiftReset[] = { "/home/alex/dwm-flexipatch/scripts/redshift.py", "reset", NULL };

static const char* suspendCmd[] = { "/home/alex/dwm-flexipatch/scripts/suspend.sh", NULL };

#if ON_EMPTY_KEYS_PATCH
static const char* firefoxcmd[] = {"firefox", NULL};
static const Key on_empty_keys[] = {
	/* modifier key            function                argument */
	{ 0,        XK_space,          spawn,                  {.v = rofi } },

	{ 0,             XK_Return,     spawn,                  {.v = termcmd } },
	{ 0,             XK_e,     spawn,                  {.v = dolphinCmd } },
	{ 0,             XK_b,     spawn,                  {.v = browserCmd } },
	{ 0,             XK_v,     spawn,                  {.v = vscodeCmd } },
	{ 0,             XK_c,     spawn,                  {.v = qtcreatorCmd } },
	{ 0,             XK_g,     spawn,                  {.v = gitkrakenCmd } },
	{ 0,             XK_o,          spawn,               {.v = obsidianCmd } },
};
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask, XK_Down,		spawn,			{.v = redshiftBrightnessDown } },
	{ MODKEY|ControlMask, XK_Up,		spawn,			{.v = redshiftBrightnessUp } },
	{ MODKEY|ControlMask, XK_Left,		spawn,			{.v = redshiftTemperatureDown } },
	{ MODKEY|ControlMask, XK_Right,		spawn,			{.v = redshiftTemperatureUp } },
	{ MODKEY|ControlMask|ShiftMask, XK_Down,		spawn,			{.v = redshiftReset } },

	{ MODKEY, XK_Home,		spawn,			{.v = pomodoroToggle } },
	{ MODKEY, XK_End,		spawn,			{.v = pomodoroSkip } },
	{ MODKEY|ShiftMask, XK_End,		spawn,			{.v = pomodoroStartStop } },
	{ MODKEY|ShiftMask|ControlMask, XK_t,		spawn,			{.v = changewallpaper } },
	{ MODKEY|ShiftMask,		XK_t,		spawn,			{.v = changetheme } },
	{ MODKEY|ShiftMask,		XK_s,		spawn,			{.v = flameshot }},
	{ MODKEY,	          	XK_z,		spawn,			{.v = medplaypausecmd }},
	{ MODKEY|ShiftMask,		XK_z,		spawn,			{.v = mednextcmd }},
	{ MODKEY|ControlMask|ShiftMask,		XK_z,		spawn,			{.v = medprevcmd }},
	{ MODKEY,		          XK_x,		spawn,			{.v = togglemic }},
	{ ShiftMask,	XF86XK_AudioMute,		spawn,			{.v = togglemic }},
	{ ShiftMask,	XF86XK_AudioLowerVolume,		spawn,			{.v = downmicvol }},
	{ ShiftMask,	XF86XK_AudioRaiseVolume,		spawn,			{.v = upmicvol }},
	...
	{ MODKEY|ShiftMask,             XK_c,     spawn,                  {.v = qtcreatorCmd } },
	{ MODKEY|ShiftMask,             XK_g,     spawn,                  {.v = gitkrakenCmd } },
...
//	{ MODKEY|Mod4Mask|ShiftMask,    XK_0,          defaultgaps,            {0} },
	...
	{ MODKEY|ControlMask,              XK_t,      unfloatvisible,         {0} },
